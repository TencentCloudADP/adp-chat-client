...
<PropsTable data={[
  ...
  { name: 'height', type: 'string | number', default: "'80vh'", description: '高度（仅在 isOverlay 为 true 时生效）' },
  ...
  { name: 'showFullscreenButton', type: 'boolean', default: 'true', description: '是否显示全屏按钮' },
  ...
  { name: 'isShowToggleButton', type: 'boolean', default: 'true', description: '是否显示悬浮切换按钮' },
