...
const handleCopy = async (content: string | undefined, _type: string) => {
    if (!content) return;
    try {
...
const handleConversationChange = (conversationId: string) => {
    console.log(`[conversationChange] ${conversationId}`);
