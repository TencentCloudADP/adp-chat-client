...
TC_SECRET_ID=
TC_SECRET_KEY=
# Tencent Cloud ADP platform agent app key: https://adp.cloud.tencent.com
APP_CONFIGS='[
    {
        "Vendor":"Tencent",
...
> 3. International: If the agent application is developed on the [ADP](https://adp.cloud.tencent.com/), set the value to true.
