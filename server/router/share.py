...
class ShareCreateApi(HTTPMethodView):
    ...
    async def post(self, request: Request):
        ...
        parser.add_argument("agent_id", type=str, required=True, location="json")
        ...
        shared = await CoreShareConversation.create(request.ctx.db, request.ctx.account_id, args["conversation_id"], args["agent_id"], records)
